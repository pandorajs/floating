! function() {
    ...
    a({
        ...
        ext: [".css"],
        exec: function(a, b) {
            var c = ['define("' + a + '#", ["importstyle"], function(require, exports, module) {', '  var source = "' + f(b) + '"', '  var importStyle = require("importstyle")', "  module.exports = function() {", '    importStyle(source, "' + a + '#")', "  }", "})"].join("\n");
            e(c)
        }
